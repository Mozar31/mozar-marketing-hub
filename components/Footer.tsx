      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-4">
        ...
        <nav className="md:col-span-2" aria-label="Ferramentas por categoria">
          ...
          <ul className="grid grid-cols-2 gap-x-4 gap-y-2 sm:grid-cols-3">
            {CATEGORIES.map((c) => (
              <li key={c.slug}>
                <Link href={`/ferramentas/categoria/${c.slug}/`} className="text-xs text-ink-300 hover:text-ink-100">
                  {c.label}
                </Link>
              </li>
            ))}
            <li>
              <Link href="/ferramentas/" className="text-xs font-semibold text-info-400 hover:underline">
                Ver todas
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="https://www.consiginvest.com/" target="_blank" rel="noopener" className="text-xs text-ink-300 hover:text-ink-100">
                Site da agência
              </a>
            </li>
            <li>
              <Link href="/sobre/" className="text-xs text-ink-300 hover:text-ink-100">
                Como funciona o Hub
              </Link>
            </li>
            <li>
              <Link href="/privacidade/" className="text-xs text-ink-300 hover:text-ink-100">
                Privacidade e dados
              </Link>
            </li>
          </ul>
